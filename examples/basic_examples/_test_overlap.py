...
a=analytical_integrals.get_ao_overlap(qc.geo_spec,qc.geo_spec,qc.ao_spec)
...
a = cy_overlap.aooverlap(ra,rb,lxlylz_a,lxlylz_b,coeffs,index,drv,int(ao_spec.normalized))
...
b=cy_overlap.aooverlap2(geo_spec,geo_spec,lxlylz,lxlylz,assign,ao_coeffs,pnum_list,atom_indices,drv,0)
