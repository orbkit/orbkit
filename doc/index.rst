...
.. The requirements for the input files, the usage via the terminal or within a 
    Python program are explained in the :doc:`manual`. 
    Information about the :doc:`cvars` and a :doc:`funcref` containing descriptions 
    to all orbkit modules is also provided presented under :doc:`funcref`.
