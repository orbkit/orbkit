...
and corresponding paper
    ...
    Qiming Sun, `"Libcint: An efficient general integral library for Gaussian basis functions" <http://dx.doi.org/10.1002/jcc.23981>`_, *J. Comput. Chem.* **2015**, *36*, 1664-1671.
