...
sys.path.append(os.path.abspath('../orbkit'))
...
latex_documents = [
  ('toctree', 'orbkit.tex', u'ORBKIT Documentation',
   u'Gunter Hermann, Vincent Pohl, Lukas Eugen Marsoner Steinkasserer, Axel Schild, and Jean Christophe Tremblay', 'manual'),
]
